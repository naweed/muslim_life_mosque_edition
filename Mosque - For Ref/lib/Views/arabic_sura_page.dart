...
import 'package:muslimlife/ViewModels/arabic_sura_page_view_model.dart';
import 'package:stacked/stacked.dart';
import 'package:super_sliver_list/super_sliver_list.dart';

class ArabicSuraPage extends StackedView<ArabicSuraPageViewModel> {
  late ArabicSuraPageViewModel pageViewModel;
  final EventBus eventBus;
  final Sura sura;

  bool isScrollNotificationEnabled = true;

  ArabicSuraPage(this.eventBus, this.sura, {super.key});

  @override
  ArabicSuraPageViewModel viewModelBuilder(BuildContext context) {
    pageViewModel = ArabicSuraPageViewModel(eventBus, sura);
    return pageViewModel;
  }

  @override
  void onViewModelReady(ArabicSuraPageViewModel viewModel) async {
    ...
    Future.delayed(500.milliseconds, () async {
      ...
      if (AppSession.ReadPageNo != 0) {
        viewModel.listController.jumpToItem(
          index: AppSession.ReadPageNo!,
  ...
  @override
  Widget builder(BuildContext context, ArabicSuraPageViewModel viewModel, Widget? child) => Scaffold(
  ...
  Widget _mainContentArea(BuildContext context, ArabicSuraPageViewModel viewModel) {
        ...
        child: NotificationListener<ScrollNotification>(
          onNotification: (scrollNotification) {
            ...
            if (scrollNotification is ScrollEndNotification) {
              ...
              viewModel.saveAyahNo(currentAyah, 0.0);
          ...
          child: CustomScrollView(
            ...
            slivers: [
              ...
              SuperSliverList.separated(
                ...
                itemCount: sura.imageCount,
                itemBuilder: (context, index) {
                  return Image.asset(
                    "${AppConstants.DataPath}/ayah_images/${sura.suraNo}_${index + 1}.png",
                  ).withLTRBPadding(16, 0, 16, 0);
                },
                separatorBuilder: (context, index) => 0.toVerticalSpacer(),
              ),
  ...
  SliverAppBar _headerContent(BuildContext context, ArabicSuraPageViewModel viewModel) {
    return SliverAppBar(
      //Back Icon
      leadingWidth: 56 - 24,
